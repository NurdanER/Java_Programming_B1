...
public class CellPhone {
    ...
    public static void main(String[] args) {
        ...
        // For the sim type [A] with camera [ has camera] the total price was $ [price]
        System.out.println("For the sim type " + sim + " with camera " + hasCamera + " the total price was $" + price);

        System.out.println();

        String fullMessage = "I have an " + model + " from "+brand + "\nIt came in the color " + color + " and it has " + storage + " GB"  +"\nFor the sim type " + sim + " with camera " + hasCamera + " the total price was $" + price;
