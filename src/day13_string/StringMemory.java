...
public class StringMemory {
    public static void main(String[] args) {
        ...
        String space =" ";  // 1 space //   //all about how the memory is used
        String str ="Java";     //it is the way creating String by LITERAL --just with double quate, (variable names are in stack stored in String pool in heap   // memory has 2 parts; stack and heap
