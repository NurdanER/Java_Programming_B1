...
public class DataBaseExample {
    ...
    public static void main(String[] args) {
        ...
        /*Map <String, Object > people = new HashMap <>(); //To have integer and String at the same time we put OBject

        people.put("FIST_NAME", "James");
        people.put("LAST_NAME", "Gosling");
        people.put("BATCH", 1);         //IF WE DONT PUT OBJECT IT WILL BE COMPLAIN



        //Create a mmethod that accepts an array of String  and return MAP


       // public static void                              //we used static because we will call that i the same class
        ...
        /*
        if we need to convert from String to int --> use  Integer.parseInt
        if we need to convert from int to String --> use String.valueOf
         */
