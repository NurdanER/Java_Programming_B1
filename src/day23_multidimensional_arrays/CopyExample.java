...
public class CopyExample {
    public static void main(String[] args) {
        ...
        /*int [] a = {1, 2, 3, 4};
        int [] b = a;          //this is not a brand new array. b is referencing to a's array  SO IT WILL BE THE SAME OUTPUTS
        ...
        int[] c = Arrays.copyOf(a, a.length);      //THIS IS A COMPLETELY BRAND NEW ARRAY !!
